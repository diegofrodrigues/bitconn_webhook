...
""",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'bitconn_webhook/static/src/css/terminal.css',
            'bitconn_webhook/static/src/js/addon-fit.js',
            'bitconn_webhook/static/src/js/bitconn_terminal_ws.js',
            'bitconn_webhook/static/src/js/bitconn_terminal_action.js',
            'bitconn_webhook/static/src/xml/terminal_templates.xml',
        ],
    },
    'license': 'LGPL-3',
    'installable': True,
